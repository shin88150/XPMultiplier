...
namespace XPMultiplier
{
    ...
    {
        public byte General { get; set; } = 15;

        public byte Combat { get; set; } = 15;

        public byte Farming { get; set; } = 15;

        public byte Fishing { get; set; } = 15;

        public byte Mining { get; set; } = 15;

        public byte Foraging { get; set; } = 15;

        public byte Luck { get; set; } = 15;
